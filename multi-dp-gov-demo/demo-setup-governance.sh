...
yq w -i $(dirname ${BASH_SOURCE})/governance/governance_agent.yml central.environment ""
...
yq w -i $(dirname ${BASH_SOURCE})/governance/governance_agent.yml aws.poolInterval 10s
yq w -i $(dirname ${BASH_SOURCE})/governance/governance_agent.yml aws.pushTags false
